...
LICENSE = "Proprietary"
LIC_FILES_CHKSUM = "file://${WORKDIR}/git/resources/sensors/LICENSE;md5=263ee034adc02556d59ab1ebdaea2cda"

SRC_URI = "git://git@github.com/hailo-ai/hailo-media-library.git;protocol=https;branch=1.5.0"
SRC_URI += "https://hailo-hailort.s3.eu-west-2.amazonaws.com/Hailo15/1.5.0/hefs.tar.gz;name=hefs"
...
RESOURCES_DIR = "${WORKDIR}/git/resources"
